...
public class Mixer extends Control{
	...
	public Mixer(){
		...
		current.apply(Interface.textureAlphaSketch(2),Interface.textureAlphaSketch(3),layerInter);		
		current.apply(Interface.textureAlphaSketch(1),layerInter,layerOutput);
		}
	}	
